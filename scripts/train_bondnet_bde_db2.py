...
Hardware Requirements:
    ...
    - RAM: 32GB+ recommended for full dataset (425K molecules requires HDF5 streaming for <64GB RAM)
    - Training time: ~10-12 hours (transfer learning) or ~3-4 days (from scratch)
    - Disk: ~10 GB (dataset + model checkpoints)
    - Note: For large datasets use HDF5 streaming loader (see scripts/bondnet_hdf5_dataset.py)
